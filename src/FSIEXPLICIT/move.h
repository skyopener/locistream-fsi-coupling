...
#define BOOST_DISABLE_ASSERTS // to disable boost asserts -> gives warning?
...
namespace streamUns {
  ...
  // Options for flexible body grid motion.
  class FlexibleBodyGridMotionOptions : public options_list {
    public:
      FlexibleBodyGridMotionOptions() : options_list("top:bottom:r:a:rbfNr:linearSolverTolerance:linearSolverMaxIterations") {} ;
  } ;
  ...
  class FlexibleBodyDisplacement {
	private:
	  int Nb, Nbd1, d ;
	  int rbfNr, linearSolverMaxIterations ;
  ...
  class BoundaryDisplacement {
    private:
      ...
      FlexibleBodyDisplacement flexibleBody ;
    public:
