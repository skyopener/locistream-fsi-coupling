...
subroutine beam1d(LociRank, LociNNodes, LociDofFree, CSDnodes, plungeAmp, flapAmp, freq, chord, rho, thickness, Young, CSDx, CSDxdot, CSDxddot, CSDForce, dt, sTime, timestep, xNew, xdotNew, xddotNew, disp) 
use mesh
use stiff
use gauss
!use eigen
