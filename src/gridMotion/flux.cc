...
namespace streamUns {
  ...
  class GCLFacetSums : public pointwise_rule {
    ...
    public:
      ...
      GCLFacetSums() {
        ...
        constraint("SIMPLE{n,it},faces{n,it}") ;
      }
  ...
  // Priority rule for grid mass flux over interior faces. Removed {n,it}
  // from all variables on 10/22/2009 so that this rule can be used by
  // both SIMPLE and PISO.
  class PriorityGridMassFluxInteriorBDF : public pointwise_rule {
    ...
    public:
      ...
      PriorityGridMassFluxInteriorBDF() {
        name_store("facetVDotNormalSum",facetVDotNormalSum) ;
        name_store("faceDensity",faceDensity) ;
        name_store("priority::gridMassFlux",gridMassFlux) ;
        input("facetVDotNormalSum,faceDensity") ;
        output("priority::gridMassFlux") ;
        constraint("BDFIntegrator,internalFaces") ;
      }
  ...
  // Priority rule for grid mass flux over inlet and outlet faces.  Removed
  // {n,it} from all variables on 10/22/2009 so that this rule can be used by
  // both SIMPLE and PISO.
  class PriorityGridMassFluxBoundaryBDF : public pointwise_rule {
    ...
    public:
      ...
      PriorityGridMassFluxBoundaryBDF() {
        ...
        name_store("priority::gridMassFlux",gridMassFlux) ;
        input("facetVDotNormalSum,rho_f") ;
        output("priority::gridMassFlux") ;
        constraint("BDFIntegrator,boundaryFaces") ;
      }
  ...
  class PriorityGridMassFluxBoundaryBDF2 : public pointwise_rule {
    ...
    public:
      ...
      PriorityGridMassFluxBoundaryBDF2() {
        ...
        output("priority::gridMassFlux{n,it}") ;
        constraint("BDF2Integrator{n,it},boundaryFaces{n,it}") ;
      }
