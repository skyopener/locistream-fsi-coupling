...
namespace streamUns {
  ...
  class RigidBodyGridMotionOptions : public options_list {
    public:
      RigidBodyGridMotionOptions() : options_list("sMag:sDir:tDir:tMag:tFreq:tPhi:rCenter:rAxis:rAlphaBar:rMag:rFreq:rPhi:func") {} ;
  } ;
  ...
  class BoundaryDisplacement {
    ...
    public:
      ...
      vect3d Value(real time,vect3d position) const {
//cout << "rank,type,constant: " << Loci::MPI_rank << " " << type << " " << constant << endl ;
