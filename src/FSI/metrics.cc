  ...
  class GridMotionVolumeUnit : public unit_rule {
    ...
    public:
      ...
      GridMotionVolumeUnit() {
        ...
        constraint("geom_cells,gridMotionTimeDependent") ;
      }
  ...
  Loci::Summation<real> > {
    ...
    public:
      ...
      GridMotionVolumeApplyInterior() {
        ...
        constraint("internalFaces,gridMotionTimeDependent") ;
      }
  ...
  Loci::Summation<real> > {
    ...
    public:
      ...
      GridMotionVolumeApplyBoundary() {
        ...
        constraint("boundaryFaces,gridMotionTimeDependent") ;
      }
