...
#line 34 "hypre.loci"
       output("hypreConvergenceTolerance") ;
#line 34 "hypre.loci"
...
#line 47 "hypre.loci"
       output("hypreMaxRowSum") ;
#line 47 "hypre.loci"
       comments("HYPRE maximum row sum parameter.") ;
#line 47 "hypre.loci"
