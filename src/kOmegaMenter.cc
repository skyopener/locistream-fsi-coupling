...
// Rules to process turbulence equation options from the .vars file.
  ...
  class TurbulenceEquationSolverParameters : public singleton_rule {
    private:
      ...
      param<real> turbulenceRelaxationFactor ;
    public:
      ...
      TurbulenceEquationSolverParameters() {
        ...
        name_store("turbulenceRelaxationFactor",turbulenceRelaxationFactor) ;
        input("turbulenceEquationOptions") ;
        output("turbulenceMaxIterations,turbulenceRelaxationFactor") ;
      }
      ...
      virtual void compute(const sequence& seq) {
        ...
        // Relaxation factor.
        if((*turbulenceEquationOptions).optionExists("relaxationFactor")){
          Loci::option_value_type optionValueType=turbulenceEquationOptions->
          ...
          switch(optionValueType){
            case Loci::REAL:
              {
                real temp ;
                turbulenceEquationOptions->getOption("relaxationFactor",temp) ;
                if(temp<=0.0 || temp>1.0){
                  cerr << "Bad relaxationFactor for turbulenceEquation."
                    << endl ; Loci::Abort() ;
                }
                *turbulenceRelaxationFactor=temp ;
              }
              break ;
            default:
              cerr << "Bad type for relaxationFactor in turbulenceEquation."
                << endl ; Loci::Abort() ;
          }
        }else{
          *turbulenceRelaxationFactor=0.5 ;
        }
...
// Scheme independent rules for assembling the k equation.
  ...
  class InitializeKMainCoefficient : public unit_rule {
    ...
    public:
      ...
      InitializeKMainCoefficient() {
        name_store("kMainCoefficient",kMainCoefficient) ;
        output("kMainCoefficient") ;
        constraint("vol") ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      FOUInviscidFluxToKMainCoefficientInterior() {
        ...
        name_store("kMainCoefficient",kMainCoefficient) ;
        input("massFlux,gridMassFlux") ;
        output("(cl,cr)->kMainCoefficient") ;
        constraint("internalFaces") ;
      }
  ...
  class InitializeKSourceTerm : public unit_rule {
    ...
    public:
      ...
      InitializeKSourceTerm() {
        name_store("kSourceTerm",kSourceTerm) ;
        output("kSourceTerm") ;
        constraint("vol") ;
      }
  ...
  Loci::Summation<real> > {
    ...
    public:
      ...
      FOUInviscidFluxToKSourceTermBoundary() {
        ...
        name_store("k_f",k_f) ;
        name_store("kSourceTerm",kSourceTerm) ;
        input("ci->k,massFlux,gridMassFlux,k_f") ;
        output("ci->kSourceTerm") ;
        constraint("boundaryFaces,fouTurbulence") ;
      }
      ...
      void calculate(Entity face) {
        ...
        else kSourceTerm[ci[face]]-=netMassFlux*(k_f[face]-k[ci[face]]) ;
      }
  ...
  Loci::Summation<real> > {
    ...
    public:
      ...
      SOUInviscidFluxToKSourceTermBoundary() {
        ...
        input("facecenter,massFlux,gridMassFlux,k_f") ;
        output("ci->kSourceTerm") ;
      ...
      void calculate(Entity face) {
        real netMassFlux=massFlux[face]-gridMassFlux[face] ;
        kSourceTerm[ci[face]]-=(netMassFlux>0.0)? netMassFlux*
          max(kLimiter[ci[face]]*dot(kGradient[ci[face]],faceCenter[face]-
          cellCenter[ci[face]]),-k[ci[face]]):netMassFlux*k_f[face] ;
      }
  ...
  Loci::Summation<real> > {
    ...
    public:
      ...
      ProductionToKSourceTerm() {
        name_store("cellRadius",cellRadius) ;
        name_store("kProduction",kProduction) ;
        name_store("kSourceTerm",kSourceTerm) ;
        input("cellRadius,kProduction") ;
        output("kSourceTerm") ;
        constraint("geom_cells") ;
      }
  ...
  class ComputeKMatrixDiagonal : public pointwise_rule {
    private:
      const_param<real> kRelaxationFactor ;
    ...
    public:
      ...
      ComputeKMatrixDiagonal() {
        name_store("turbulenceRelaxationFactor",kRelaxationFactor) ;
        name_store("kMainCoefficient",kMainCoefficient) ;
        name_store("kStar_D",D) ;
        input("turbulenceRelaxationFactor,kMainCoefficient") ;
        output("kStar_D") ;
        constraint("geom_cells") ;
      }
      ...
      void calculate(Entity cell) {
        D[cell]=kMainCoefficient[cell]/(*kRelaxationFactor) ;
      }
  ...
  class ComputeKRHS : public pointwise_rule {
    ...
    public:
      ...
      ComputeKRHS() {
        ...
        input("turbulenceRelaxationFactor,k,kMainCoefficient,kSourceTerm") ;
        output("kStar_B") ;
        constraint("geom_cells") ;
      }
      ...
      // Add relaxation for a single cell.
      void calculate(Entity cell) {
        B[cell]=kSourceTerm[cell]+(1.0-(*kRelaxationFactor))*
          kMainCoefficient[cell]*k[cell]/(*kRelaxationFactor) ;
      }
  ...
  class KCellHack : public pointwise_rule {
    ...
    public:
      ...
      // Compute k for a sequence of faces.
      virtual void compute(const sequence &seq) { do_loop(seq,this) ; }
  } ;
  ...
  class ComputeKProductionIncompressible : public pointwise_rule {
    ...
    public:
      ...
      ComputeKProductionIncompressible() {
        ...
        name_store("vol",vol) ;
        name_store("kProduction",kProduction) ;
        input("rho,k,eddyViscosity,gradv3d(v),vol") ;
        output("kProduction") ;
  ...
  class ComputeKProductionSST2003Incompressible : public pointwise_rule {
    ...
    public:
      ...
      ComputeKProductionSST2003Incompressible() {
        ...
        name_store("vol",vol) ;
        name_store("kProduction",kProduction) ;
        input("betaStar,rho,k,omega,eddyViscosity,gradv3d(v),vol") ;
        output("kProduction") ;
        constraint("incompressibleFlow,geom_cells") ;
        constraint("menterSST2003TurbulenceModel") ;
      }
...
// Scheme independent rules for assembling the omega equation.
  ...
  class InitializeOmegaMainCoefficient : public unit_rule {
    ...
    public:
      ...
      InitializeOmegaMainCoefficient() {
        name_store("omegaMainCoefficient",omegaMainCoefficient) ;
        output("omegaMainCoefficient") ;
        constraint("vol") ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      FOUInviscidFluxToOmegaMainCoefficientInterior() {
        ...
        name_store("omegaMainCoefficient",omegaMainCoefficient) ;
        input("massFlux,gridMassFlux") ;
        output("(cl,cr)->omegaMainCoefficient") ;
        constraint("internalFaces") ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      FOUInviscidFluxToOmegaMainCoefficientBoundary() {
        ...
        name_store("omegaMainCoefficient",omegaMainCoefficient) ;
        input("massFlux,gridMassFlux") ;
        output("ci->omegaMainCoefficient") ;
        constraint("boundaryFaces") ;
      }
  ...
  class InitializeOmegaSourceTerm : public unit_rule {
    ...
    public:
      ...
      InitializeOmegaSourceTerm() {
        name_store("omegaSourceTerm",omegaSourceTerm) ;
        output("omegaSourceTerm") ;
        constraint("vol") ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      FOUInviscidFluxToOmegaSourceTermBoundary() {
        ...
        name_store("omega_f",omega_f) ;
        name_store("omegaSourceTerm",omegaSourceTerm) ;
        input("ci->omega,massFlux,gridMassFlux,omega_f") ;
        output("ci->omegaSourceTerm") ;
        constraint("boundaryFaces,fouTurbulence") ;
      }
      ...
      void calculate(Entity face) {
        ...
        if(netMassFlux<=0.0) omegaSourceTerm[ci[face]]-=netMassFlux*
          omega_f[face] ;
        else omegaSourceTerm[ci[face]]-=netMassFlux*(omega_f[face]-
          omega[ci[face]]) ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      SOUInviscidFluxToOmegaSourceTermBoundary() {
        ...
        input("facecenter,massFlux,gridMassFlux,omega_f") ;
        output("ci->omegaSourceTerm") ;
        constraint("boundaryFaces,souTurbulence") ;
      }
  ...
  <store<real>,Loci::Summation<real> > {
    ...
    public:
      ...
      ProductionAndCrossDiffusionToOmegaSourceTerm() {
        ...
        input("rho,omega,eddyViscosity,kProduction") ;
  ...
  class ComputeOmegaMatrixDiagonal : public pointwise_rule {
    private:
      const_param<real> omegaRelaxationFactor ;
    ...
    public:
      ...
      ComputeOmegaMatrixDiagonal() {
        name_store("turbulenceRelaxationFactor",omegaRelaxationFactor) ;
        name_store("omegaMainCoefficient",omegaMainCoefficient) ;
        name_store("omegaStar_D",D) ;
        input("turbulenceRelaxationFactor,omegaMainCoefficient") ;
        output("omegaStar_D") ;
        constraint("geom_cells") ;
      }
      ...
      // Add relaxation for a single cell.
      void calculate(Entity cell) {
        D[cell]=omegaMainCoefficient[cell]/(*omegaRelaxationFactor) ;
      }
  ...
  class ComputeOmegaRHS : public pointwise_rule {
    ...
    public:
      ...
      ComputeOmegaRHS() {
        ...
        input("turbulenceRelaxationFactor,omega,omegaMainCoefficient") ;
        input("omegaSourceTerm") ;
        output("omegaStar_B") ;
        constraint("geom_cells") ;
      }
      ...
      // Add relaxation for a single cell.
      void calculate(Entity cell) {
        B[cell]=omegaSourceTerm[cell]+(1.0-(*omegaRelaxationFactor))*
          omegaMainCoefficient[cell]*omega[cell]/(*omegaRelaxationFactor) ;
      }
  ...
  class OmegaCellHack : public pointwise_rule {
    ...
    public:
      ...
      // Compute omega for a sequence of faces.
      virtual void compute(const sequence &seq) { do_loop(seq,this) ; }
  } ;
...
// Rules to limit k and omega.
  ...
  class LimitKOmega : public pointwise_rule {
    private:
    ...
    public:
      ...
      LimitKOmega() {
        ...
        input("debug,turbulenceIntensityFreestream") ;
        input("cellcenter,rho,v,laminarViscosity,eddyViscosity,kStar,omegaStar") ;
        output("kStarLimited=kStar") ;
        output("omegaStarLimited=omegaStar") ;
        constraint("geom_cells") ;
      }

      // Limit k and omega for a single cell. We have put a fix in for the
      ...
      // Added clipping for omega getting large. Limit to twice the maximum
      // wall value.
      void calculate(Entity cell) {
        if(kStar[cell]>=0.0 && omegaStar[cell]>0.0) return ;

        /* New version. Doesn't work as good as old.
        real omegaLowerLimit=1.0e-05,omegaUpperLimit=2.0*(*maxOmegaWall) ;
        if(kStar[cell]<0.0 && omegaStar[cell]>0.0 && omegaStar[cell]<omegaUpperLimit){
          if(*debug && Loci::MPI_rank==0){
            cout << "WARNING: k bad and omega good for cell " << cell << endl ;
            cout << "  cellcenter: " << cellCenter[cell] << endl ;
            cout << "  omega: " << omegaStar[cell] << endl ;
            cout << "  maxOmegaWall: " << *maxOmegaWall << endl ;
            cout << "  rho: " << rho[cell] << endl ;
            cout << "  v: " << v[cell] << endl ;
            cout << "  k: " << kStar[cell] << endl ;
            cout << "  laminarViscosity: " << laminarViscosity[cell] << endl ;
            cout << "  eddyViscosity: " << eddyViscosity[cell] << endl ;
          }
          // K is bad, so use the current eddy viscosity and the good value of omega
          // to compute a new k.
          if(*debug && Loci::MPI_rank==0) cout << "Start new k assign" << endl ;
          kStar[cell]=eddyViscosity[cell]*omegaStar[cell]/rho[cell] ;
          if(*debug && Loci::MPI_rank==0) cout << "End new k assign" << endl ;
        }else if(kStar[cell]>0.0 && omegaStar[cell]<=0.0){
          if(*debug && Loci::MPI_rank==0){
            cout << "WARNING: k good and omega bad for cell " << cell << endl ;
            cout << "  cellcenter: " << cellCenter[cell] << endl ;
            cout << "  omega: " << omegaStar[cell] << endl ;
            cout << "  maxOmegaWall: " << *maxOmegaWall << endl ;
            cout << "  rho: " << rho[cell] << endl ;
          ...
          // Omega is bad, so use the current eddy viscosity and the good value of k
          // to compute a new omega.
          omegaStar[cell]=(eddyViscosity[cell]>0.01*laminarViscosity[cell])?
            rho[cell]*kStar[cell]/eddyViscosity[cell]:rho[cell]*kStar[cell]/
            (0.01*laminarViscosity[cell]) ;
          // If resulting omega is unnaturally low, then clip it.
          omegaStar[cell]=max(omegaStar[cell],omegaLowerLimit) ;
        }else if(kStar[cell]<0.0 || omegaStar[cell]<=0.0){
          if(*debug && Loci::MPI_rank==0){
            cout << "WARNING: k and omega both bad for cell " << cell << endl ;
            cout << "  cellcenter: " << cellCenter[cell] << endl ;
            cout << "  omega: " << omegaStar[cell] << endl ;
            cout << "  maxOmegaWall: " << *maxOmegaWall << endl ;
            cout << "  rho: " << rho[cell] << endl ;
          ...
          // Both k and omega are bad, so set new values using freestream conditions
          // with the current value of eddy viscosity.
          real vMag=norm(v[cell]) ;
          kStar[cell]=1.5*pow((*turbulenceIntensityFreestream)*vMag,2) ;
          omegaStar[cell]=(eddyViscosity[cell]>0.01*laminarViscosity[cell])?
            rho[cell]*kStar[cell]/eddyViscosity[cell]:rho[cell]*kStar[cell]/
            (0.01*laminarViscosity[cell]) ;
          // If resulting omega is unnaturally low, then clip it.
          omegaStar[cell]=max(omegaStar[cell],omegaLowerLimit) ;
        }else if(omegaStar[cell]>2.0*(*maxOmegaWall)){
          if(*debug && Loci::MPI_rank==0){
            cout << "WARNING: Omega too high for cell " << cell << endl ;
            cout << "  cellcenter: " << cellCenter[cell] << endl ;
            cout << "  omega: " << omegaStar[cell] << endl ;
            cout << "  maxOmegaWall: " << *maxOmegaWall << endl ;
            cout << "  rho: " << rho[cell] << endl ;
          ...
          omegaStar[cell]=omegaUpperLimit ;
        }*/

        // Old version.
        if(kStar[cell]<0.0 || omegaStar[cell]<=0.0){
          if(*debug){
          ...
          kStar[cell]=1.5*pow((*turbulenceIntensityFreestream)*vMag,2) ;
          if(vMag>1.0e-10){
            omegaStar[cell]=rho[cell]*kStar[cell]/(100.0*laminarViscosity[cell]) ;
            if(omegaStar[cell]<1.0e-15) omegaStar[cell]=1.0e-15 ;
          }else{
            omegaStar[cell]=1.0 ;
          }
        }else if(omegaStar[cell]>1.0e+15){
          if(*debug){
          ...
          omegaStar[cell]=1.0e+15 ;
        }
      }

      // Limit k and omega for a sequence of cells.
      void compute(const sequence &seq) { do_loop(seq,this) ; }
  } ;

  register_rule<LimitKOmega> registerLimitKOmega ;

  // Limit k and omega to positive values using freestream k and omega values.
  class LimitKOmegaPriority : public pointwise_rule {
    private:
      const_param<real> kFreestream,omegaFreestream ;
      const_store<real> rho ;
      const_store<vect3d> v ;
      const_store<real> laminarViscosity ;
      store<real> kStar,omegaStar ;
    public:
      ...
      LimitKOmegaPriority() {
        ...
        name_store("kStar",kStar) ;
        name_store("omegaStar",omegaStar) ;
        input("kFreestream,omegaFreestream") ;
        input("kStar,omegaStar") ;
        output("priority::kStarLimited=kStar") ;
        output("priority::omegaStarLimited=omegaStar") ;
        constraint("geom_cells") ;
      }

      // Limit k and omega for a single cell.
      void calculate(Entity cell) {
        if(kStar[cell]<0.0) kStar[cell]=(*kFreestream) ;
        if(omegaStar[cell]<=0.0) omegaStar[cell]=(*omegaFreestream) ;
      }
  ...
  register_rule<LimitKOmegaPriority> registerLimitKOmegaPriority ;
...
// are used by the other families of k-omega models.
  ...
  class IterationBuildKOmega : public pointwise_rule {
    private:
      const_store<real> kTimeStepN,omegaTimeStepN ;
      store<real> kIterationZero,omegaIterationZero ;
    public:

      // Define input and output.
      IterationBuildKOmega() {
        name_store("k{n}",kTimeStepN) ;
        name_store("omega{n}",omegaTimeStepN) ;
        name_store("k{n,it=0}",kIterationZero) ;
        name_store("omega{n,it=0}",omegaIterationZero) ;
        input("k{n},omega{n}") ;
        output("k{n,it=0},omega{n,it=0}") ;
        constraint("geom_cells{n},kOmegaTurbulenceModel{n}") ;
      }

      // Assign k and omega at iteration zero for a single cell.
      void calculate(Entity cell) {
        kIterationZero[cell]=kTimeStepN[cell] ;
        omegaIterationZero[cell]=omegaTimeStepN[cell] ;
      }

      // Assign k and omega at iteration zero for a sequence of cells.
      void compute(const sequence &seq) { do_loop(seq,this) ; }
  } ;

  register_rule<IterationBuildKOmega> registerIterationBuildKOmega ;

  // Rule to add temporal component of the k equation to the main coefficient.
  class TemporalToKMainCoefficient: public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
    ...
    public:
      ...
      TemporalToKMainCoefficient() {
        ...
        name_store("kMainCoefficient{n,it}",kMainCoefficient) ;
        input("rho{n},vol{n},cellRadius{n,it}") ;
        input("timeStepFactor{n},timeIntegratorFactor0{n}") ;
        output("kMainCoefficient{n,it}") ;
        constraint("geom_cells") ;
      }

      // Add temporal component for a single cell.
      void calculate(Entity cell) {
        kMainCoefficient[cell]+=rho[cell]*vol[cell]*cellRadius[cell]*
  ...
  // Rule to add temporal component of the omega equation to the main
  // coefficient.
  class TemporalToOmegaMainCoefficient: public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
      const_param<real> timeIntegratorFactor0 ;
      const_store<real> timeStepFactor ;
    ...
    public:
      ...
      TemporalToOmegaMainCoefficient() {
        ...
        name_store("vol{n}",vol) ;
        name_store("cellRadius{n,it}",cellRadius) ;
        name_store("omegaMainCoefficient{n,it}",omegaMainCoefficient) ;
        input("rho{n},vol{n},cellRadius{n,it}") ;
        input("timeStepFactor{n},timeIntegratorFactor0{n}") ;
        output("omegaMainCoefficient{n,it}") ;
        constraint("geom_cells") ;
      }

      // Add temporal component for a single cell.
      void calculate(Entity cell) {
        omegaMainCoefficient[cell]+=rho[cell]*vol[cell]*cellRadius[cell]*
          (*timeIntegratorFactor0)/timeStepFactor[cell] ;
      }
  ...
  class TemporalToKSourceTerm : public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
      const_param<real> timeIntegratorFactor0 ;
      const_store<real> timeStepFactor ;
    ...
    public:
      ...
      TemporalToKSourceTerm() {
        ...
        input("rho{n},k{n},vol{n},cellRadius{n,it}") ;
        input("timeStepFactor{n},timeIntegratorFactor0{n}") ;
      ...
      void calculate(Entity cell) {
        kSourceTerm[cell]+=(rho[cell]*vol[cell]*cellRadius[cell]*
          (*timeIntegratorFactor0)/timeStepFactor[cell])*k[cell] ;
      }
  ...
  // Rule to add temporal component of k equation to the source term
  // for the BDF2 scheme.
  class TemporalToKSourceTermBDF2 : public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
    ...
    public:
      ...
      TemporalToKSourceTermBDF2() {
        ...
        name_store("cellRadius{n,it}",cellRadius) ;
        name_store("kSourceTerm{n,it}",kSourceTerm) ;
        input("rho{n-1},k{n-1},k{n,it},vol{n,it}") ;
      ...
      // Add temporal component to source term for a single cell.
      void calculate(Entity cell) {
        kSourceTerm[cell]+=((*timeIntegratorFactor1)*rhoOld[cell]*
  ...
  register_rule<TemporalToKSourceTermBDF2> registerTemporalToKSourceTermBDF2 ;

  // Rule to add temporal component of the omega equation to the source term.
  class TemporalToOmegaSourceTerm : public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
      const_param<real> timeIntegratorFactor0 ;
      const_store<real> timeStepFactor ;
    ...
    public:
      ...
      TemporalToOmegaSourceTerm() {
        ...
        input("rho{n},omega{n},vol{n},cellRadius{n,it}") ;
        input("timeStepFactor{n},timeIntegratorFactor0{n}") ;
      ...
      // Add temporal component to source term for a single cell.
      void calculate(Entity cell) {
        omegaSourceTerm[cell]+=(rho[cell]*vol[cell]*cellRadius[cell]*
          (*timeIntegratorFactor0)/timeStepFactor[cell])*omega[cell] ;
      }
  ...
  // for the BDF2 scheme.
  class TemporalToOmegaSourceTermBDF2 : public apply_rule<store<real>,Loci::
  Summation<real> > {
    private:
      const_param<real> timeIntegratorFactor1 ;
      const_store<real> timeStepFactor ;
    ...
    public:
      ...
      TemporalToOmegaSourceTermBDF2() {
        ...
        name_store("cellRadius{n,it}",cellRadius) ;
        name_store("omegaSourceTerm{n,it}",omegaSourceTerm) ;
        input("rho{n-1},omega{n-1},omega{n,it},vol{n,it}") ;
        input("cellRadius{n,it},timeStepFactor{n},timeIntegratorFactor1{n}") ;
        output("omegaSourceTerm{n,it}") ;
        constraint("geom_cells,BDF2Integrator") ;
      }
      ...
      // Add temporal component to source term for a single cell.
      void calculate(Entity cell) {
        omegaSourceTerm[cell]+=((*timeIntegratorFactor1)*rhoOld[cell]*
          vol[cell]*cellRadius[cell]/timeStepFactor[cell])*
          (omega[cell]-omegaOld[cell]) ;
      }
  ...
  register_rule<TemporalToOmegaSourceTermBDF2>
    registerTemporalToOmegaSourceTermBDF2 ;
  ...
  class IterationAdvanceKOmega : public pointwise_rule {
    private:
      const_store<real> kStar,omegaStar ;
      store<real> kIterationPlusOne,omegaIterationPlusOne ;
    public:

      // Define input and output.
      IterationAdvanceKOmega() {
        name_store("kStarLimited{n,it}",kStar) ;
        name_store("omegaStarLimited{n,it}",omegaStar) ;
        name_store("k{n,it+1}",kIterationPlusOne) ;
        name_store("omega{n,it+1}",omegaIterationPlusOne) ;
        input("kStarLimited{n,it},omegaStarLimited{n,it}") ;
        output("k{n,it+1},omega{n,it+1}") ;
        constraint("geom_cells{n,it},kOmegaTurbulenceModel{n,it}") ;
      }

      // Assign k and omega at end of iteration for a single cell.
      void calculate(Entity cell) {
        kIterationPlusOne[cell]=kStar[cell] ;
        omegaIterationPlusOne[cell]=omegaStar[cell] ;
      }

      // Assign k and omega at end of iteration for a sequence of cells.
      void compute(const sequence &seq) { do_loop(seq,this) ; }
  } ;
